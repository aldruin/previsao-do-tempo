...
#Variaveis
times_20_colocados = ('PALMEIRAS', 'INTERNACIONAL', 'FLUMINENSE', 'CORINTHIANS', 'FLAMENGO', 'ATHLETICO PARANAENSE', 'ATLETICO MINEIRO', 'FORTALEZA', 'SAO PAULO', 'AMERICA FC SAF', 'BOTAFOGO', 'SANTOS', 'GOIAS', 'RED BULL BRAGANTINO', 'CORITIBA', 'CUIABA SAF', 'CEARA', 'ATLETICO', 'AVAI', 'JUVENTUDE')
cinco_primeiros = []
quatro_ultimos = []
